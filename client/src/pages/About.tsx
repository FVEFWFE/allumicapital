          ...
          <div className="max-w-[1400px] mx-auto px-8">
            <div className="max-w-4xl">
              ...
              <p className="text-lg font-light text-white/70 leading-relaxed mb-8" data-testid="text-about-intro">
                Quadrant Private Equity is a leading private equity firm based in Australia, focused on partnering with exceptional businesses and management teams to create long-term value.
              </p>
            </div>
          </div>
        </section>
